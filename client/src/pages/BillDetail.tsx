        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="glass grid grid-cols-2 sm:grid-cols-4 gap-px overflow-hidden mb-6">
              <Stat label="Billing Period" value={data.bill.billingPeriod || "—"} />
              <Stat label="Account ID" value={data.bill.accountId || "—"} />
              <Stat label="Line Items" value={String(data.bill.itemCount)} />
              <Stat label="Grand Total (USD)" value={grandTotal !== null ? usd(grandTotal) : "—"} />
            </div>
              ...
              <div
                className={`mb-6 p-4 rounded-[var(--radius-glass)] border ${
                  reconciles
                    ...
                    : "border-amber-600/40 bg-amber-50/60"
                }`}>
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-mono uppercase tracking-[0.2em] text-muted-foreground">
                {data.items.length} line items · red square = AI-classified
              </span>
            </div>
